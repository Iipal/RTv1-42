...
inline t_v4df	rt_normal_sphere(const t_v4df p,
								const t_v4df d,
...
inline t_v4df	rt_normal_cone(const t_v4df p,
								const t_v4df d,
								const Camera *restrict const cam,
								const void *restrict const obj_ptr)
{
...
inline t_v4df	rt_normal_plane(const t_v4df p,
								const t_v4df d,
								const Camera *restrict const cam,
								const void *restrict const obj_ptr)
{
	const t_v4df	obj_dir = ((Object*)obj_ptr)->dir;
...
inline t_v4df	rt_normal_cylinder(const t_v4df p,
								const t_v4df d,
								const Camera *restrict const cam,
								const void *restrict const obj_ptr)
{
	const t_v4df	o_pos = ((Object*)obj_ptr)->pos;
	const t_v4df	o_dir = ((Object*)obj_ptr)->dir;
